...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        computationstart_time = perf_counter()
        ...
        computationtime += (perf_counter() - computationstart_time)  
    ...
    if(epoch == 1):
        print('\nTrain Epoch: {} \n Batch Size: {} \n Epoch Computation: {:.6f}  \n'.format(epoch, args.batchtraining, computationtime))
