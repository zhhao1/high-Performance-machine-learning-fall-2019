...
parser.add_argument('--batchtraining', type=int, default=128, metavar='N', help='batch size for training')
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        datacomputationstarttime = perf_counter()
        ...
        epochtotaltime += perf_counter() - datacomputationstarttime 
